...
class KnowledgeAgent:
    def __init__(self, directory="knowledge_base"):
        self.directory = os.path.join(BASE_DIR, directory) # Use absolute path
    ...
    async def run(self, query: str) -> str:
        if not self.knowledge: return "Knowledge base is empty."
    ...
    def _get_credentials(self):
        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                ...
                # --- THIS LINE IS NOW FIXED TO USE THE ABSOLUTE PATH ---
